...
namespace DReI.BackWeb.Controllers
{
    ...
    public class DeclaracionesController : ApiController
    {
        ...
        public DeclaracionesController(DeclaracionesService service)
        {
            _service = service;
        }
        ...
        {
            var declaraciones = _service.ObtenerDeclaracionesPorCuentaYAnio(cuenta, anio)
        ...
        public IHttpActionResult Crear(DeclaracionesDTO dto)
        {
            ...
            _service.CrearDeclaracion(nuevaDeclaracion);
